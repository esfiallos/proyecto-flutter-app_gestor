...
class Profile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Menú inferior curvo (como en el otro diseño)
      bottomNavigationBar: BottomAppBar(
        shape: const CircularNotchedRectangle(),
        notchMargin: 0,
        height: 50, // Más delgado
        ...
        child: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                // Aquí puedes poner la navegación a tu pantalla de inicio
              },
            ),
            IconButton(
